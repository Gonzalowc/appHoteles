...
/**
 * Clase Manejador Hotel Servicio para realizar todas las consultas en cuanto a
 * la relacion de Hotel y Servicio
 * 
...
public class ManejadorHotelServicio {
	...
	/**
	 * Metodo Servicios de hotel para consultar los servicios que nos ofrece un
	 * hotel
	 * 
	...
	/**
	 * Metodo para consultar si un Servicio pertenece a un Hotel / si el Hotel
	 * contiene Servicios
	 * 
	 * @param con      para conseguir la conexion
	 * @param hotel    objeto que usamos para comprobar y relacionar con servicio
	 * @param servicio objeto objeto que usamos para comprobar y relacionar con
	 *                 hotel
